...
scripts = ["p0_webscraping.py"]
# scripts = ["p0_webscraping.py", "p2_extract.py", "p3_llmExtraction.py", "p4_analysis.py"]
...
llm_extracted_folder = Path(config['paths']['outputs_json'])
results_folder = Path(config['paths']['outputs_excel'])
