"""qa_childcare_aggregate.py — Stage 4 aggregator + audit for childcare.
...
def main():
    print("=== Stage 4 (childcare) — aggregate + audit ===")
    ...
    logging_util.log_event("childcare", "stage_4", "aggregate+audit",
