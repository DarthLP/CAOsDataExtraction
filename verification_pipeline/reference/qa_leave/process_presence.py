#!/usr/bin/env python3
"""
Topic-presence check for Dutch CAO QA.
...
if __name__ == "__main__":
    input_path = "/Users/lorenzpiazolo/Documents/Claude/Projects/Dutch Bargaining Agreements/qa_leave/outputs/subagent_chunks/chunk_002.jsonl"
    output_path = "/Users/lorenzpiazolo/Documents/Claude/Projects/Dutch Bargaining Agreements/qa_leave/outputs/subagent_chunks/chunk_002_presence.csv"

    try:
        rows_written, presence_distribution = process_chunk(input_path, output_path)

        # Report
        print(f"rows_written: {rows_written}")
        print(f"output_path: {output_path}")
        print(f"presence_status distribution:")
        for status, count in presence_distribution.items():
