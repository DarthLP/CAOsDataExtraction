...
USAGE:
    ...
    Bash script for parallel execution (supports GOOGLE_API_KEY1 to GOOGLE_API_KEY22):
        caffeinate python -u pipelines/p3_llmExtraction.py --key_number 1 --process_id 0 --total_processes 22 > p3_log1.txt 2>&1 &
        caffeinate python -u pipelines/p3_llmExtraction.py --key_number 2 --process_id 1 --total_processes 22 > p3_log2.txt 2>&1 &
        caffeinate python -u pipelines/p3_llmExtraction.py --key_number 3 --process_id 2 --total_processes 22 > p3_log3.txt 2>&1 &
        caffeinate python -u pipelines/p3_llmExtraction.py --key_number 4 --process_id 3 --total_processes 22 > p3_log4.txt 2>&1 &
        caffeinate python -u pipelines/p3_llmExtraction.py --key_number 5 --process_id 4 --total_processes 22 > p3_log5.txt 2>&1 &
        caffeinate python -u pipelines/p3_llmExtraction.py --key_number 6 --process_id 5 --total_processes 22 > p3_log6.txt 2>&1 &
        caffeinate python -u pipelines/p3_llmExtraction.py --key_number 7 --process_id 6 --total_processes 22 > p3_log7.txt 2>&1 &
        caffeinate python -u pipelines/p3_llmExtraction.py --key_number 8 --process_id 7 --total_processes 22 > p3_log8.txt 2>&1 &
        caffeinate python -u pipelines/p3_llmExtraction.py --key_number 9 --process_id 8 --total_processes 22 > p3_log9.txt 2>&1 &
        caffeinate python -u pipelines/p3_llmExtraction.py --key_number 10 --process_id 9 --total_processes 22 > p3_log10.txt 2>&1 &
        caffeinate python -u pipelines/p3_llmExtraction.py --key_number 11 --process_id 10 --total_processes 22 > p3_log11.txt 2>&1 &
        caffeinate python -u pipelines/p3_llmExtraction.py --key_number 12 --process_id 11 --total_processes 22 > p3_log12.txt 2>&1 &
        caffeinate python -u pipelines/p3_llmExtraction.py --key_number 13 --process_id 12 --total_processes 22 > p3_log13.txt 2>&1 &
        caffeinate python -u pipelines/p3_llmExtraction.py --key_number 14 --process_id 13 --total_processes 22 > p3_log14.txt 2>&1 &
        caffeinate python -u pipelines/p3_llmExtraction.py --key_number 15 --process_id 14 --total_processes 22 > p3_log15.txt 2>&1 &
        caffeinate python -u pipelines/p3_llmExtraction.py --key_number 16 --process_id 15 --total_processes 22 > p3_log16.txt 2>&1 &
        caffeinate python -u pipelines/p3_llmExtraction.py --key_number 17 --process_id 16 --total_processes 22 > p3_log17.txt 2>&1 &
        caffeinate python -u pipelines/p3_llmExtraction.py --key_number 18 --process_id 17 --total_processes 22 > p3_log18.txt 2>&1 &
        caffeinate python -u pipelines/p3_llmExtraction.py --key_number 19 --process_id 18 --total_processes 22 > p3_log19.txt 2>&1 &
        caffeinate python -u pipelines/p3_llmExtraction.py --key_number 20 --process_id 19 --total_processes 22 > p3_log20.txt 2>&1 &
        caffeinate python -u pipelines/p3_llmExtraction.py --key_number 21 --process_id 20 --total_processes 22 > p3_log21.txt 2>&1 &
        caffeinate python -u pipelines/p3_llmExtraction.py --key_number 22 --process_id 21 --total_processes 22 > p3_log22.txt 2>&1 &
