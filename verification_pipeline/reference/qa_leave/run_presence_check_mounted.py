...
Uses mounted path for bash environment.
"""
...
if __name__ == "__main__":
    # Use mounted path
    input_file = "/sessions/confident-wonderful-cori/mnt/Dutch Bargaining Agreements/qa_leave/outputs/subagent_chunks/chunk_002.jsonl"
    output_file = "/sessions/confident-wonderful-cori/mnt/Dutch Bargaining Agreements/qa_leave/outputs/subagent_chunks/chunk_002_presence.csv"

    try:
        rows_written, presence_distribution = process_chunk(input_file, output_file)
