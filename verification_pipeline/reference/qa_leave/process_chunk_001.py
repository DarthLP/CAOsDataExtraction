#!/usr/bin/env python3
"""
Topic-presence check for Dutch CAO QA - chunk_001.
Processes chunk_001.jsonl and outputs presence_status for each record × topic_group.
"""
...
if __name__ == "__main__":
    input_file = Path("outputs/subagent_chunks/chunk_001.jsonl")
    output_file = Path("outputs/subagent_chunks/chunk_001_presence.csv")
