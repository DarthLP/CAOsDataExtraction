"""qa_training_build_chunks.py — Stage 3 setup: build chunk JSONLs + system prompt.

Reads corrections_deterministic.csv, builds ChunkItems with field-anchored
slicing, partitions into chunks of ~20 items each, writes worksheets/chunks/.
Writes worksheets/system_prompt.txt.
"""
...
def main():
    ...
    chunks = worksheet_builder.build_chunk_items(records, "training")
